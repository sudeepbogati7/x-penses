  ...
  return (
    <>
      ...
      <div className=" h-screen w-full md:w-2/3 xl:w-1/2 mx-auto">
        ...
        <div className='shadow-gray-500/10  items-center justify-around text-base shadow-md text-gray-500 dark:text-gray-400 flex  gap-6  px-6 py-4  '>
        ...
        <footer className='h-1/12  dark:bg-darkColor flex  dark:border-gray-600 p-4 justify-around  w-full'>
