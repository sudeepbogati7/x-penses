            ...
            <main>
                ...
                <div className='flex z-0 pb-24 flex-col flex-wrap align-center justify-center container  p-4 md:w-2/3  mx-auto xl:w-1/3 xl:border-2 xl:border-gray-300  xl:mt-14 rounded-xl  w-full'>
                    ...
                    >
                        ...
                        <div className='px-4'>
                            <button type="submit" className='border my-6 rounded-xl p-2 text-md font-medium tracking-wide w-full  mx-auto hover:bg-orange-700 hover:text-white transition-all duration-300 ease-in-out border-orange-600' > Register </button>
                        </div>

                        <div className='mx-auto text-base'>Already have an account? <Link href={'/login'}> <span className='text-orange-600 border-b border-orange-400'> Login  </span> </Link></div>
                    </form>
                </div>
            </main>
